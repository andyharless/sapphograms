...
im = create_sapphogram(f'data/fragment{fragment}greek.txt', orange=True)
im.save(f'output/sappho{fragment}v5small.png')
im_large = im.resize(DIMS, resample=Image.NEAREST)
im_large.save(f'output/sappho{fragment}v5large.png')

with open(f'output/sappho{fragment}img_data_v5.txt', 'w') as f:
